...
Without memoization, fibonacci(44) would take a very long time.

With memoization, the function returns almost instantly.

Learning Outcomes

Understand the concept of memoization.

Learn how to cache results for recursive functions.

Apply memoization to optimize slow calculations.

Understand why pure functions are ideal for memoization.   